...
model_combinations <- expand_grid(simtype       = c("ST"),
  ...
  mutate(data_in       = str_c("data_", simtype, "_", nat_haz, "_", stratum, "_", init),
         ...
         col_resp_var  = case_when(profile == "MP" & resp_var_type == "abs"  ~ 15,
                                   ...
                                   TRUE ~ 999),
         tree_compl    = 3,
         learning_rate = c(0.02, 0.01, 0.02, 0.008, 0.007, 0.02, 0.01, 0.01, 0.01, # ST A MP abs UM (1, 2, 3) - SA (1, 2, 3) ## CHECK AGAIN
                           0.02, 0.01, 0.02, 0.008, 0.007, 0.01, 0.007, 0.01, 0.01, # ST A MP diff
                           0.008, 0.009, 0.02, 0.01, 0.03, 0.01, 0.01, 0.01, 0.01, # ST A IP abs
                           0.007, 0.007, 0.02, 0.01, 0.03, 0.01, 0.01, 0.01, 0.01, # ST A IP diff
                           0.005, 0.01, 0.01, 0.01, 0.01, 0.02, 0.005, 0.007, 0.007, # ST LED MP abs
                           0.005, 0.01, 0.01, 0.01, 0.01, 0.02, 0.005, 0.01, 0.01, # ST LED MP diff
                           0.009, 0.01, 0.007, 0.01, 0.01, 0.01, 0.02, 0.01, 0.01, # ST LED IP abs
                           0.01, 0.01, 0.007, 0.01, 0.01, 0.01, 0.02, 0.01, 0.009), # ST LED IP diff
         bag_fraction  = 0.75)
